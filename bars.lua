...
function bars.initialize(o)
    ...
    o.right_cap_image = images.new({
        ...
        texture = { path = windower.addon_path .. 'bg_cap2.png', fit = true },
        repeatable = { x = 1, y = 1 },
        draggable = false
    })
    o.name_text = texts.new('${name|(Name)}: ${hpp|(100)}%', {
        pos = { x = 0, y = 0 },
        text = { size = o.font_size, font = o.font, stroke = { width = 1.5, alpha = 150, red = 0, green = 0, blue = 0 } },
        flags = { bold = true, draggable = false, italic = true },
        bg = { visible = false }
    })
    o.action_text = texts.new('${action|(Action)}', {
        pos = { x = 0, y = 0 },
        text = { size = o.font_size * 0.8, font = o.font, stroke = { width = 1.5, alpha = 150, red = 0, green = 0, blue = 0 } },
    ...
    o.target_name_text = texts.new('${pc|(Target)}', {
        pos = { x = 0, y = 0 },
        text = { size = o.font_size, font = o.font, stroke = { width = 2, alpha = 150, red = 0, green = 0, blue = 0 } },
        flags = { bold = true, draggable = false },
        bg = { visible = false }
    })
    o.distance_text = texts.new('${dist|(0.0)}\'', {
        pos = { x = 0, y = 0 },
        text = { size = o.font_size * 0.8, font = o.font, stroke = { width = 2, alpha = 150, red = 0, green = 0, blue = 0 } },
        flags = { bold = true, draggable = false, right = true },
        bg = { visible = false }
    })
...
function bars.move(o, x, y)
    ...
    o.left_cap_image:pos(x - 19, y - 4)
    o.background_body_image:pos(x + 1, y - 4)
    o.foreground_body_image:pos(x + 1, y)
    o.right_cap_image:pos(x + 1 + o.width, y - 4)
    o.name_text:pos(x + math.floor(o.width / 100), y - 18 + (14 - o.font_size) / 4)
    o.action_text:pos(-(bars.x_res - (x + o.width - math.floor(o.width / 100))), y - o.font_size - 6)
